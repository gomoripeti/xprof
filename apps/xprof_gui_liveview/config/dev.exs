...
config :xprof_gui_liveview, XprofGuiLiveviewWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "Y3cUhi1py7e/Re6joc7skTXJpXgCH/7VagE+L9ZxXfn8gUoktspmzBBn01Ad/0+9",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:xprof_gui_liveview, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:xprof_gui_liveview, ~w(--watch)]}
  ]
...
config :xprof_gui_liveview, dev_routes: true
