defmodule XprofGuiLiveview.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: XprofGuiLiveview.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    XprofGuiLiveviewWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
